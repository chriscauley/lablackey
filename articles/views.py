...
from resources.models import PressItem
from var import header
from datetime import datetime
from content.models import CopyPhoto

ARTICLE_PAGINATION = getattr(settings, 'ARTICLE_PAGINATION', 20)
photo = CopyPhoto.objects.get(name="blog-header")
...
def display_blog_page(request, tag=None, username=None, year=None, month=None, page=1):
    ...
    context.update({'paginator': paginator,
                    'page_obj': page,
                    'press_items': PressItem.objects.all()})
