...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('content_pageimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=9999)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Page'])),
        ...
        db.send_create_signal('content', ['PageImage'])

        # Deleting field 'Section.flatpage'
        db.delete_column('content_section', 'flatpage_id')

        # Adding field 'Section.page'
        db.add_column('content_section', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['content.Page']),
                      keep_default=False)

        # Adding field 'Page.title'
        db.add_column('content_page', 'title',
                      self.gf('django.db.models.fields.CharField')(default='arst', max_length=128),
                      keep_default=False)

        # Adding field 'Page.slug'
        db.add_column('content_page', 'slug',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('content_pageimage')


        # User chose to not deal with backwards NULL issues for 'Section.flatpage'
        raise RuntimeError("Cannot reverse this migration. 'Section.flatpage' and its values cannot be restored.")
        # Deleting field 'Section.page'
        db.delete_column('content_section', 'page_id')

        # Deleting field 'Page.title'
        db.delete_column('content_page', 'title')

        # Deleting field 'Page.slug'
        db.delete_column('content_page', 'slug')
